...
$(info ${CLR_CYN}  _____                             _   _   ___ 	)
$(info ${CLR_CYN} | ____|   ___    ___   _ __ ___   | | | | |_ _|	)
$(info ${CLR_CYN} |  _|    / __|  / _ \ | '_ ` _ \  | | | |  | |	)
$(info ${CLR_CYN} | |___  | (__  |  __/ | | | | | | | |_| |  | |	)
$(info ${CLR_CYN} |_____|  \___|  \___| |_| |_| |_|  \___/  |___|	)
$(info ${CLR_CYN}													)
$(info ${CLR_CYN}			Feel my hands in your hair :)			)
$(info ${CLR_CYN}=================================================================$(CLR_RST))
$(info $(CLR_BOLD)${CLR_CYN}ECEM_VERSION=$(ECEM_VERSION)$(CLR_RST))
