...
""" % bcb_dev)
  ...
  if GetBuildProp("ro.ecem.version", OPTIONS.info_dict) is not None:
    buildid = GetBuildProp("ro.ecem.version", OPTIONS.info_dict)
    ...
    device = GetBuildProp("ro.ecem.device", OPTIONS.info_dict)
